...
- **Módulo de bodega** (fase 1, se activa por empresa desde súper admin): inicio con Ingreso, Salida, Inventario y Dashboard; ingresos con OC, guía y fotos; salidas con quién retira y quién despacha; SOH mantenido por la base en `skus.stock_sistema`; movimientos con anulación y pendientes de aprobación; stock actual; listas de proveedores y personas; cola sin conexión. Diseño en `docs/DISENO-MODULO-BODEGA.md`.
